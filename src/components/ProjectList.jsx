...
const arr = [
	{
		...
		description: `Технологии искусственного интеллекта и анализа данных
Программа на базовом уровне. Для более глубокого изучения включаются модули использования, конфигурирования и программирование в в системах управления контентом (CMS) на языке программирования PHP.
На программе обучаются студенты как ИТ-специальностей, так и не ИТ-специальностей
Квалификация - Технологии искусственного интеллекта и анализа данных
Длительность обучения - 10 месяцев
Уровень - профессиональная переподготовка
Количество обучающихся - 620 человек`,
	},
	{
		photo: 'phone',
		side: 'left',
		...
		description: `Проектирование в CAD-системах
Программа Проектирование в CAD-системах включает получение навыков работы по созданию 3D моделей зданий. Построенные модели являются основой для получения основных архитектурных чертежей необходимых при проектировании.
На программе обучаются студенты не ИТ-специальностей.
Квалификация - Создание, использование и сопровождение информационной модели ОКС на всех этапах его жизненного цикла
Длительность обучения - 10 месяцев
Уровень - профессиональная переподготовка
Количество обучающихся - 206 человек`,
	},
	// {
	// 	photo: 'computer',
	// 	side: 'right',
...
На программе обучаются студенты как ИТ-специальностей, так и не ИТ-специальностей.
Квалификация - Web-разработка
Длительность обучения - 10 месяцев
Уровень - профессиональная переподготовка
Количество обучающихся - 640 человек`,
	},
];
